...
/**
 * Class IntercityRoutesInfoFeedParser
 * @package Weasty\Bundle\TransportBundle\Parser
 */
class IntercityRoutesInfoFeedParser extends TransportInfoFeedParser {
  /**
   * @param $offset
   * @param $limit
   *
  ...
  protected function getFeed( $offset, $limit ) {
    $feedUrl = 'http://www.minsktrans.by/ru/newsall/news/newsmg.feed?type=atom&limitstart='.$offset;
