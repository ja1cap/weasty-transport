...
/**
 * Class HolidayTransportInfoFeedParser
 * @package Weasty\Bundle\TransportBundle\Parser
 */
class HolidayTransportInfoFeedParser extends TransportInfoFeedParser {
  /**
   * @param $offset
   * @param $limit
   *
  ...
  protected function getFeed( $offset, $limit ) {
    $feedUrl = 'http://www.minsktrans.by/ru/newsall/news/prazdnichnye-perevozki.feed?type=atom&limitstart='.$offset;
